const SystemBackdrop = () => {
    return (
        <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden opacity-[0.09]" aria-hidden="true">
            <svg className="absolute left-0 top-0 h-full w-full" viewBox="0 0 1600 2200" preserveAspectRatio="none">
                ...
                <g fill="hsl(var(--primary))">
                    <circle cx="240" cy="360" r="10"/>
                    <circle cx="420" cy="230" r="10"/>
                    <circle cx="610" cy="330" r="10"/>
                    <circle cx="1310" cy="315" r="10"/>
                    <circle cx="465" cy="1080" r="10"/>
                    <circle cx="1010" cy="720" r="10"/>
                    <circle cx="1190" cy="1375" r="10"/>
                    <circle cx="555" cy="1585" r="10"/>
                    <circle cx="1150" cy="1920" r="10"/>
                </g>

                <g stroke="hsl(var(--primary))" strokeWidth="1.5" fill="none" opacity="0.7">
